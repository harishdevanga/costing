        ...
        if uploaded_file:
            ...
            if isinstance(df6, dict):
                ...
                with solder_bar_col:
                    ...
                    solder_bar_cost = st.text_input('Solder Bar Cost($/g)', value="0.024", key="solder_bar_cost", disabled=True)
                    ...
                    try:
                        ...
                        solder_bar_cost = float(solder_bar_cost) if solder_bar_cost else 0.0
                        ...
                        solderbar_cost_per_brd = circumferential_plus_barrel_fill_solder_wt * solder_bar_cost
                    ...
                    # st.text_input('Solder Bar Cost($/g)', value=f"{solder_bar_cost:.2f}", key="solder_bar_cost", disabled=True) 

        ...
        if uploaded_file:
            ...
            if isinstance(df6, dict):
                ...
                with flux_col:
                    ...
                    # flux_board_area = st.text_input('Flux Board Area(mm^2)', value="0.0", key="flux_board_area", disabled=True)
                    ...
                    # Display results
                    st.text_input('Flux Board Area(mm^2)', value=f"{flux_board_area_value:.2f}", key="flux_board_area", disabled=True)
                    ...
                    if st.button("Save Consumable, RM & Conversion Costing Details"):
                        if sheet_name in st.session_state.edited_sheets:
                            ...
                            columns_to_add = [
                                ...
                                "Flux Wastage %","Flux Cost($/ml)","Flux Board Area(mm^2)","Flux Spread Area(mm^2)","Flux Cost Per Board($)", #Flux Wave Soldering section
                            ...
                            current_data.loc[0, "Flux Board Area(mm^2)"] = flux_board_area_value
                ...
                fig.update_layout(
                    title_text='RM Cost vs Conversion Cost',

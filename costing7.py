        ...
        if uploaded_file:
            ...
            if isinstance(df5, dict):
                ...
                with solder_top_col:
                    ...
                    st.text_input('Weight of solder paste for Weight Estimate (g)', value=f"{top_weight_of_solder_paste_for_wt_estimate_value:.2f}", key="top_solder_paste_weight_estimate", disabled=True)
                ...
                with solder_bottom_col:
                    ...
                    # Display results
                    st.text_input('Weight of solder paste for Weight Estimate (g)', value=f"{bot_weight_of_solder_paste_for_wt_estimate_value:.2f}", key="bot_solder_paste_weight_estimate", disabled=True)
                ...
                with ohpandother_percentage_col:
                    ...
                    for row_labels in percentage_labels_grouped:
                        ...
                        for i, label in enumerate(row_labels):
                            cols[i].text_input(label, value=str(selected_percentages.get(label, "")), disabled=True) #added .get to handle cases where the label might not exist
                ...
                #         st.form_submit_button(label='Submit (This does not perform any action in this example)') # just for visual grouping
